    		...
    		var sjObj=o;
		        ...
		        sjObj.defaults={
		            ...
		            df_btn:function(){
		                ...
		                return $("<div class='df-btn' style='height:"+sjObj.opt.btnHeight+"px'><div class='df-ok'>"+sjObj.opt.okText+"</div><div class='df-no'>"+sjObj.opt.cancelText+"</div></div>")
		            },
		            ...
		            y:10,
		            nowTime:new Date(),
		            startYear:1920, //自定义开始年份
		            endYear:(new Date()).getFullYear(), //自定义结束年份
		            ampmText:null,//上午下午
		            //结构字符串生成
		            dataNum:0,
